...
function Results() {
  ...
  const [message, setMessage] = useState("Olá! Busque por Pedidos de Venda, Pedidos de Compra, Produtos, Equipamentos e Mão de Obra no seu ERP.");
  ...
  return (
    <div className="d-flex flex-column align-items-center gap-3 mb-5 col-12 col-md-8 col-lg-5">
      {
        showMessageBox &&
